 ...
 * @internal
 */
export interface RedshiftDataHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<RedshiftDataClientResolvedConfig, HandlerExecutionContext, RedshiftDataHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultRedshiftDataHttpAuthSchemeParametersProvider: (config: RedshiftDataClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<RedshiftDataHttpAuthSchemeParameters>;
/**
 * @internal
 */
